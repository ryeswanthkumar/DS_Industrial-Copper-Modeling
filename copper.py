...
class prediction:
    ...
    def regression():
        ...
        if button:
            ...
            with open(r'C:/Users/HP/Documents/project/copper modelling/regression_model.pkl', 'rb') as f:
                model = pickle.load(f)
    ...
    def classification():
        ...
        if button:
            ...
            with open(r'C:/Users/HP/Documents/project/copper modelling/Classification_model.pkl', 'rb') as f:
                model = pickle.load(f)
